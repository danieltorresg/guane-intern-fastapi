...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            user_same_email, marks=[pytest.mark.dependency(name="duplicate_email")]
        ),
    ],
)
def test_create_duplicate_user(test_app: TestClient, duplicate_user: dict):
    ...
    assert (
        response_duplicate.status_code >= 400 and response_duplicate.status_code < 500
    ), response_duplicate.text
    assert response_duplicate.json() == {
        "detail": "Duplicate key: There is a user with tis data"
    }
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            user_standard, marks=[pytest.mark.dependency(name="deactivate_standard")]
        ),
        pytest.param(
            user_deactivate,
            marks=[pytest.mark.dependency(name="deactivate_userdeactivate")],
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            user_standard,
            updates[0],
            marks=[pytest.mark.dependency(name="update_name")],
        ),
        pytest.param(
            user_standard,
            updates[1],
            marks=[pytest.mark.dependency(name="update_last_name")],
        ),
        pytest.param(
            user_standard,
            updates[2],
            marks=[pytest.mark.dependency(name="update_password")],
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            updates[1],
            marks=[pytest.mark.dependency(name="update_last_name_inexistent")],
        ),
        pytest.param(
            updates[2],
            marks=[pytest.mark.dependency(name="update_password_inexistent")],
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            some_users, marks=[pytest.mark.dependency(name="filter_users_full")]
        )
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            some_users, marks=[pytest.mark.dependency(name="filter_users_full_daniel")]
        ),
